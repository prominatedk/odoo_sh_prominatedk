...
class AccountInvoice(models.Model):
    ...
    def _get_bankintegration_vendorbill_domain(self, company, journal):
        if company.set_validate_payment:
            return [('payment_status', '=', False), ('type', '=', 'in_invoice'), ('state', '=', 'open'), ('payment_autopay', '=', True), ('company_id', '=', company.id), ('payment_journal', '=', journal.id)]
        else:
            return [('payment_status', '=', False), ('type', '=', 'in_invoice'), ('state', '=', 'open'), ('payment_duedate', '<=', fields.Date.today(self)), ('payment_autopay', '=', True), ('company_id', '=', company.id), ('payment_journal', '=', journal.id)]
