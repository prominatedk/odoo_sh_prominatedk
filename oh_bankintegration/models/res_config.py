...
class ResConfigSettings(models.TransientModel):
    ...
    use_extended_import = fields.Boolean(
    ...
    def get_values(self):
        ...
        use_extended_import = get_param('use_extended_import')
        ...
        if isinstance(get_param('use_extended_import'), str):
            use_extended_import = ast.literal_eval(
                get_param('use_extended_import'))
        ...
        res.update(
            ...
            use_extended_import=use_extended_import,
            use_bban=use_bban
        )
        return res
    ...
    def set_values(self):
        ...
        try:
            ...
            set_param('use_extended_import', repr(self.use_extended_import))
