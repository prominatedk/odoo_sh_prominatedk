...
class ResConfig(models.TransientModel):
    ...
    primecargo_shipping_product_id = fields.Many2one('product.primecargo.shipping', related="company_id.primecargo_shipping_code", readonly=False, string="PrimeCargo Shipping Product", help="Contains the PrimeCargo Shipping Product Code as per agreement with PrimeCargo for this delivery")
